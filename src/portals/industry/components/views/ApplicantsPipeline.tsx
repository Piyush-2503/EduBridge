      ...
      <div className="bg-white p-5 sm:p-6 rounded-2xl border border-slate-200/80 shadow-2xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1 max-w-2xl">
            Streamlined recruitment pipeline: Track candidate progression from initial application through proctored diagnostic assessments to final Pre-Placement Offers (PPOs).
          </p>
        </div>
