...
interface LandingAppProps {
  onLaunchPortal?: (portal: PortalType) => void;
  initialPortal?: PortalType | null;
}

export default function App({ onLaunchPortal, initialPortal }: LandingAppProps) {
  const [activeView, setActiveView] = useState<ActiveView>(
    initialPortal ? (`login-${initialPortal}` as ActiveView) : 'landing'
  );
